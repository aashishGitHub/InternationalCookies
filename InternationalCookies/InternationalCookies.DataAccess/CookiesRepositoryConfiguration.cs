    ...
    public static class CookiesRepositoryConfiguration
    {
        ...
        public static void Initialise()
        {
            ...
            CookiesUnityContainer.Current
                ...
                @"Server=internationalcookies.database.windows.net;Initial Catalog=InternationalCookies;Persist Security Info=False;User ID=Aashish;Password=Password.123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;")
